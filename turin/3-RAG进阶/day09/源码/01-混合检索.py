...
#     documents=split_docs, embedding=embeddings_model, persist_directory=persist_directory
# )
vectorstore = Chroma(embedding_function=embeddings_model, persist_directory=persist_directory)
...
# bm25_retriever_doc = bm25_retriever.invoke(question)
# print("-------------------bm25检索-------------------------")
# print(bm25_retriever_doc)


# 混合检索
retriever = EnsembleRetriever(retrievers=[bm25_retriever, vector_retriever], weights=[0.5, 0.5])
ensemble_retriever_doc = retriever.invoke(question)
print("-------------------混合检索-------------------------")
print(ensemble_retriever_doc)
